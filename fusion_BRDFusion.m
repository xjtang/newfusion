...
%
% Updates of Version 6.2.1 - 12/08/2014 (by Xiaojing Tang)
%   1.Set ETM to nan if = -9999
%
% Updates of Version 6.2.2 - 1/21/2015 (by Xiaojing Tang)
%   1.Bugs fixed.
%
...
function fusion_BRDFusion(main)
    ...
    for I_Day = 1:numel(main.date.swath)
        ...
        for I_TIME = 1:numel(File.MOD09SUB)
            ...
            % save
            save([main.output.modsubbrdf,plat,'09SUBFB.','ALL.',DayStr,'.',TimeStr,'.mat'],'-struct','MOD09SUB');
