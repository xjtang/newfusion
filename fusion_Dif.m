...
function fusion_Change(main)
    ...
    for I_Day=1:numel(main.date.swath)
        ...
        File.Check = dir([main.output.modsubd plat '*' num2str(main.set.res) '*' DayStr '*']);
        ...
        for I_TIME = 1:numel(File.MOD09SUB)
            ...
            [MOD09SUB.DIF09RED,~] = swathDIF(MOD09SUB.MOD09RED,...
                MOD09SUB.FUS09RED,MOD09SUB.QACloud,1,400,1,main.set.bias);
            [MOD09SUB.DIF09NIR,~] = swathDIF(MOD09SUB.MOD09NIR,...
            ...
            [MOD09SUB.DIF09NDVI,~] = swathDIF(MOD09SUB.MOD09NDVI,...
                MOD09SUB.FUS09NDVI,MOD09SUB.QACloud,1,0.2,1,main.set.bias);

            if main.set.res == 500
                [MOD09SUB.DIF09BLU,~] = swathDIF(MOD09SUB.MOD09BLU,...
                    MOD09SUB.FUS09BLU,MOD09SUB.QACloud,1,200,1,main.set.bias);
                [MOD09SUB.DIF09GRE,~] = swathDIF(MOD09SUB.MOD09GRE,...
                    MOD09SUB.FUS09GRE,MOD09SUB.QACloud,1,200,1,main.set.bias);
                [MOD09SUB.DIF09SWIR,~] = swathDIF(MOD09SUB.MOD09SWIR,...
                    MOD09SUB.FUS09SWIR,MOD09SUB.QACloud,1,500,1,main.set.bias);
                [MOD09SUB.DIF09SWIR2,~] = swathDIF(MOD09SUB.MOD09SWIR2,...
                    MOD09SUB.FUS09SWIR2,MOD09SUB.QACloud,1,400,1,main.set.bias);
            end

            % save
            save([main.output.modsubd,plat,'09SUBD.',num2str(main.set.res),'m.',DayStr,'.',TimeStr,'.mat'],'-struct','MOD09SUB');
