...
%
% Updates of Version 1.3.3 - 12/3/2015
...
function fusion_Dif(main)
    ...
    % check platform
    if strcmp(main.set.plat,'MOD') || strcmp(main.set.plat,'MYD')
        plat = main.set.plat;
    else
        plat = 'M*D';
    end
    ...
    for I_Day=1:numel(main.date.swath)
        ...
        % find MOD09FUS files
        File.MOD09SUB = dir([main.output.modsubf,plat,'09FUS','*',DayStr,'*']);
        ...
        for I_TIME = 1:numel(File.MOD09SUB)
            ...
            % save
            save([main.output.modsubd,plat,'09DIF.','ALL.',DayStr,'.',TimeStr,'.mat'],'-struct','MOD09SUB');
