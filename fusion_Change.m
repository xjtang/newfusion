...
%
% Updates of Version 1.6 - 1/26/2016
...
function fusion_Change(main)
    ...
    for i = jobLine
        ...
        CHG.Class = ones(samp,1)*(main.LCclass.NA);
        CHG.ChangeDate = ones(samp,1)*(main.LCclass.NA);
        CHG.DetectDate = ones(samp,1)*(main.LCclass.NA);
        ...
        for j = 1:samp
            ...
            % assign class
            [CHG.Class,CHG.ChangeDate,CHG.DetectDate] = genMap(squeeze(CHG.Data(j,:)),CHG.Date,main.model,main.TSclass,main.LCclass);
