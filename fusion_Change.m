...
%
% Updates of Version 1.4 - 9/18/2015
%   2.Records model coefficients in the output.
%
...
function fusion_Change(main)
    ...
    for i = jobLine
        ...
        CHG.Coef = ones(6,samp,length(main.model.band))*(-9999);
        ...
        for j = 1:samp
            ...
            % detect change
            [CHG.Data(j,:),CHG.Coef(:,j,:)] = change(PTS,main.model);
