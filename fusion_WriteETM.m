...
function fusion_WriteETM(main)
    ...
    for I_Day=1:numel(main.date.swath)
        ...
        % find MOD09SUB files
        File.MOD09SUB = dir([main.output.modsubd,plat,'09SUBD.',num2str(main.set.res),'*',DayStr,'*']);
        ...
        for I_TIME = 1:numel(File.MOD09SUB)
            ...
            if main.set.res == 500
                ...
                ETMImage = 0*ones([numel(ETMGeo.Line),numel(ETMGeo.Samp),4]);
            end
            ...
            if main.set.res == 500
                ...
                if main.set.dif == 0
                    ...
                    [~,ETMImage(:,:,2),~] = swath2etm(MOD09SUB.DIF09NIR,MOD09SUB,ETMGeo);
            ...
            % save as ENVI imsge
            mkdir([main.output.dif,plat,'DIF',num2str(main.set.res),DayStr,'T',TimeStr]);
            enviwrite([main.output.dif,plat,'DIF',num2str(main.set.res),DayStr,'T',TimeStr,...
                '/',plat,'DIF',num2str(main.set.res),DayStr,'T',TimeStr,'_stack'],...
