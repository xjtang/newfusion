...
%
% Updates of Version 1.1 - 9/23/2015
...
function fusion_GenMap(main)
    ...
    CMAP = ones(length(main.etm.line),length(main.etm.sample),length(main.model.band),6)*-9999;
    ...
    for i = (main.etm.line)'
        ...
        for j = main.etm.sample
            ...
            CMAP(i,j,:,5) = CHG.Coef(5,j,:);
            CMAP(i,j,:,6) = CHG.Coef(6,j,:);
