...
%
% Updates of Version 1.1.2 - 11/11/2015
...
function fusion_GenMap(main)
    ...
    for i = 1:6
        ...
        % determine file name
        if i == 1
            outFile = [main.output.coefmap 'Mean'];
        elseif i == 2
            outFile = [main.output.coefmap 'Std'];
        elseif i == 3
            outFile = [main.output.coefmap 'Intercept'];
        elseif i == 4
            outFile = [main.output.coefmap 'Slope'];
        elseif i == 5
            outFile = [main.output.coefmap 'Rsquared'];
        elseif i == 6
            outFile = [main.output.coefmap 'RMSE'];
        end
