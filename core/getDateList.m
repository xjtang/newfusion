...
% 
% Output Arguments: 
%   dateList (Vector,Long) - vector of Julian dates of all images in the
%       input directory.
%
% Usage: 
%   1.Call by other scripts with correct input and output arguments.
%
% Version 6.1 - 10/8/2014 (by Xiaojing Tang)
%   This function checks all the image files in the inpur directory and
%       output a list of Julian dates of those images.
%
