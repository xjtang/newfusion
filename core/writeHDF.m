...
%   Data (Matrix, Numeric) - data to be written (the precision must be the same as the layer).
%   Start (Vector, Integer, 1x2) - the start point of the writting process ([0 0] by default if not specified).
%
% Output Arguments: 
